    ...
    <div className="bg-white">
      ...
      <section className="section section-py bg-boon-navy relative overflow-hidden">
        ...
        <div className="container-xl relative z-10">
          ...
          <h2 className="font-sans text-3xl md:text-5xl lg:text-[74px] font-bold tracking-tight leading-[0.9] text-white mb-20 max-w-5xl">
      ...
      <section className="section section-py bg-white">
        <div className="container-xl">
          <div className="section-header mb-16">
            ...
            <h2 className="font-sans text-3xl md:text-5xl lg:text-[74px] font-bold tracking-tight leading-[0.95] md:leading-[0.9] text-boon-charcoal mb-10">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-8 md:gap-16">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-6 md:gap-10">
                <p className="text-white/60 font-body font-medium leading-relaxed text-base md:text-lg max-w-xs">
      ...
      <section className="section section-py bg-boon-navy text-center relative overflow-hidden">
        ...
        <div className="container-md relative z-10">
          <h2 className="font-sans text-3xl md:text-5xl lg:text-[74px] font-bold text-white mb-8 tracking-tight leading-tight lg:leading-[0.9]">
