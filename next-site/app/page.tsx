...
export default function HomePage() {
  return (
    <div className="bg-white">
      ...
      <section className="py-32 px-6 md:px-12 lg:px-24 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 max-w-5xl mx-auto">
            ...
            <h2 className="font-sans text-3xl md:text-5xl lg:text-7xl font-bold tracking-tight leading-[0.95] md:leading-[0.9] text-boon-charcoal mb-10">
      ...
      {/* Mid-page CTA */}
      <section className="py-16 md:py-24 px-6 md:px-12 lg:px-24 bg-gradient-to-b from-boon-navy/90 to-boon-navy text-center relative overflow-hidden">
      ...
      <section className="py-32 md:py-64 bg-boon-navy px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <h2 className="font-sans text-3xl md:text-6xl lg:text-[110px] font-bold text-white mb-8 tracking-tight leading-tight lg:leading-[0.9]">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <Link
              href="/solutions"
              className="bg-white/5 border border-white/10 text-white px-8 py-4 md:px-16 md:py-8 rounded-[15px] font-sans font-bold text-lg md:text-lg hover:bg-white/10 transition-all"
            >
              See how it works
            </Link>
          </div>
