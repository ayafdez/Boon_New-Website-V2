          ...
          <div className="flex flex-wrap gap-4 mb-10">
            ...
            {event.downloadUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-white text-boon-coral px-8 py-4 rounded-[15px] font-bold text-base border-2 border-boon-coral hover:bg-boon-coral hover:text-white transition-all"
              >
