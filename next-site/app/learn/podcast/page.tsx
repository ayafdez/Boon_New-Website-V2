        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#1DB954]/10 text-[#1DB954] px-5 py-3 rounded-[15px] text-sm font-bold hover:bg-[#1DB954]/20 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#D56DFB]/10 text-[#9933CC] px-5 py-3 rounded-[15px] text-sm font-bold hover:bg-[#D56DFB]/20 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#FF0000]/10 text-[#FF0000] px-5 py-3 rounded-[15px] text-sm font-bold hover:bg-[#FF0000]/20 transition-colors"
            >
