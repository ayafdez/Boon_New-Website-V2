    ...
    <section className="py-24 md:py-48 px-6 md:px-12 lg:px-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-24 max-w-6xl mx-auto">
          ...
          <h2 className="font-sans text-3xl md:text-5xl lg:text-[74px] font-bold text-boon-charcoal mb-12 tracking-tight leading-tight lg:leading-[0.9]">
            One leadership system. <br />
            <span className="font-serif italic">Not four disconnected programs.</span>
          </h2>
          <p className="text-base md:text-lg font-body font-medium text-gray-500 leading-relaxed max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {systemItems.map((item) => (
            <Link
              ...
              className="p-6 md:p-8 lg:p-14 bg-boon-off-white rounded-[32px] md:rounded-[64px] text-left border border-gray-100 hover:border-transparent hover:shadow-2xl transition-all h-full flex flex-col justify-between group overflow-hidden relative"
            >
              <div
              ...
              <div className="pt-6">
                ...
                <h3 className="font-sans text-2xl lg:text-3xl font-bold whitespace-nowrap">
