    ...
    <section className="py-16 md:py-32 px-6 md:px-12 lg:px-24 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-sans text-3xl md:text-5xl lg:text-7xl font-bold tracking-tight leading-[0.95] md:leading-[0.9] text-boon-charcoal mb-6">
            Don&apos;t just take <span className="font-serif italic text-boon-blue">our word</span> for it
          </h2>
          <p className="text-base md:text-xl text-gray-500 font-body font-medium max-w-3xl mx-auto">
