    ...
    <section style={{ padding: 'clamp(56px,8vw,100px) clamp(16px,4vw,40px)', background: '#F0F3F7', fontFamily: "'Inter', sans-serif" }}>
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 'clamp(36px,5vw,64px)' }}>
          <p style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.18em', color: C.blue, textTransform: 'uppercase', marginBottom: 20, fontFamily: "'Inter', sans-serif" }}>
          ...
          <p style={{ fontSize: 'clamp(15px, 1.5vw, 18px)', color: '#64748B', maxWidth: 600, margin: '28px auto 0', lineHeight: 1.65, fontWeight: 500 }}>
