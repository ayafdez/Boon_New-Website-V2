    ...
    <section style={{ padding: 'clamp(56px,8vw,100px) clamp(16px,4vw,40px)', background: '#F0F3F7', fontFamily: "'Inter', sans-serif" }}>
      <div style={{ maxWidth: 1120, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 'clamp(36px,5vw,64px)' }}>
          <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.18em', color: C.blue, textTransform: 'uppercase', marginBottom: 16 }}>
            THE SYSTEM ARCHITECTURE
          </div>
          <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 'clamp(28px,4vw,44px)', fontWeight: 800, color: '#2E353D', lineHeight: 1.15, marginBottom: 4 }}>
            One leadership system.
          </div>
          <div style={{ fontFamily: "'DM Serif Text', serif", fontSize: 'clamp(28px,4vw,44px)', fontStyle: 'italic', color: C.blue, lineHeight: 1.15, marginBottom: 20 }}>
            Not four disconnected programs.
          </div>
          <p style={{ fontSize: 'clamp(13px,1.5vw,15px)', color: '#64748B', maxWidth: 520, margin: '0 auto', lineHeight: 1.65 }}>
              ...
              return (
                <div
                  ...
                  style={{
                    padding: '14px 4px',
                    cursor: 'pointer',
                    borderBottom: i < TABS.length - 1 ? '1.5px solid rgba(0,0,0,0.08)' : 'none',
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                      <div style={{
                        ...
                        color: isActive ? color : '#8C9AB0',
                        transition: 'all 0.2s ease',
                      }}>
                        <IconEl name={
                          i === 0 ? 'grid' : i === 1 ? 'trendUp' : i === 2 ? 'bars' : i === 3 ? 'star' : 'users'
                        } color={isActive ? color : '#8C9AB0'} size={16} />
                      </div>
                      <div style={{ fontSize: 13, fontWeight: 700, fontFamily: "'DM Sans', sans-serif", color: isActive ? color : '#8C9AB0', transition: 'color 0.2s ease' }}>
                        {tab.name}
                      </div>
                    </div>
                    <span style={{ fontSize: 15, color: C.blue, opacity: isActive ? 1 : 0, transform: isActive ? 'translateX(0)' : 'translateX(-4px)', transition: 'opacity 0.2s ease, transform 0.2s ease' }}>→</span>
                  </div>
                  {/* Tab body — shown only when active & not platform */}
                  {isActive && i > 0 && tab.desc && (
                    <div style={{ paddingLeft: 44, marginTop: 8, paddingBottom: 4 }}>
                      <p style={{ fontSize: 12, color: '#64748B', lineHeight: 1.55, marginBottom: 8 }}>{tab.desc}</p>
                      <a href="#" style={{ fontSize: 11, fontWeight: 800, color: C.blue, letterSpacing: '0.03em', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 4 }}>
                        EXPLORE PILLAR →
                      </a>
                    </div>
                  )}
