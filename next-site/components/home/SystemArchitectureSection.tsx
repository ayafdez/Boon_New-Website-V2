...
const PRODUCTS: (ProductData | null)[] = [
  ...
  // SCALE
  {
    ...
    stats: [
      ...
      { iconSvg: 'trendUp',  iconBg: 'rgba(70,111,246,0.10)', label: 'Utilization Rate',    value: '68%',  sub: 'vs 54% avg',      color: C.blue },
      { iconSvg: 'clock',    iconBg: 'rgba(70,111,246,0.10)', label: 'Avg Sessions/User',   value: '11.2', sub: 'This quarter',     color: C.blue },
      { iconSvg: 'calendar', iconBg: 'rgba(70,111,246,0.10)', label: 'Sessions This Week',  value: '89',   sub: '89% attendance',  color: C.blue },
    ],
    cards: [
  ...
  // GROW
  {
    ...
    stats: [
      ...
      { iconSvg: 'bars',     iconBg: 'rgba(255,141,128,0.12)', label: 'Manager Confidence',  value: '+31%',   sub: 'vs baseline',     color: C.lCoral },
      { iconSvg: 'clock',    iconBg: 'rgba(255,141,128,0.12)', label: 'Sessions Completed',  value: '189',    sub: 'This cohort',     color: C.lCoral },
      { iconSvg: 'calendar', iconBg: 'rgba(255,141,128,0.12)', label: 'Cohort Progress',     value: 'Mo 4/6', sub: 'On track',        color: C.lCoral },
    ],
    cards: [
  ...
  // EXEC
  {
    ...
    stats: [
      ...
      { iconSvg: 'clock',    iconBg: 'rgba(196,122,204,0.13)', label: 'Avg Tenure',        value: '14mo', sub: 'Engagement length', color: C.purple },
      { iconSvg: 'calendar', iconBg: 'rgba(196,122,204,0.13)', label: 'Renewal Rate',      value: '89%',  sub: '+11% vs last yr',  color: C.purple },
    ],
    cards: [
  ...
  // TOGETHER
  {
    color: C.gold, iconBg: 'rgba(255,201,105,0.12)',
    badgeText: 'TOGETHER Active', badgeBg: 'rgba(255,201,105,0.15)', badgeColor: C.gold,
    ...
    cards: [
      ...
      { tag: 'TOGETHER', tagColor: C.gold, title: 'Alignment Outcomes', iconSvg: 'trendUp',  iconBg: 'rgba(255,201,105,0.16)', borderColor: 'rgba(255,201,105,0.38)', rows: [['Pre/post alignment','+52%'],['Shared language','High'],['Momentum score','91%',C.gold]], footer: 'Teams report clarity post-session' },
      { tag: 'TOGETHER', tagColor: C.gold, title: 'Active Programs',    iconSvg: 'calendar', iconBg: 'rgba(255,201,105,0.16)', borderColor: 'rgba(255,201,105,0.38)', rows: [['Active programs','8 cohorts'],['Total participants','96'],['Team agreement','+31%',C.gold]], footer: '8 active cohorts across org' },
      { tag: 'TOGETHER', tagColor: C.gold, title: 'Upcoming Sessions',  iconSvg: 'calendar', iconBg: 'rgba(255,201,105,0.16)', borderColor: 'rgba(255,201,105,0.38)', rows: [['Next session','Feb 24'],['Focus','Post-merger'],['RSVP rate','89%',C.gold]], footer: 'Integration workshop — all leads invited' },
    ],
  },
];
...
const PLATFORM_CARDS: QuadCard[] = [
  ...
  { tag: 'TOGETHER', tagColor: C.gold,  title: 'Team Workshops',      iconSvg: 'users',    iconBg: 'rgba(255,201,105,0.16)', borderColor: 'rgba(255,201,105,0.45)', rows: [['Active programs','8 cohorts'],['Total participants','96'],['Team alignment','+31%',C.gold]], footer: 'Upcoming: Post-merger integration workshop' },
];
