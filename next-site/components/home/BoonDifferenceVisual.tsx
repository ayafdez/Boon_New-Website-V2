    ...
    <div className="w-full max-w-5xl mx-auto space-y-16">
      ...
      <div>
        <div className="mb-8 text-center">
          ...
          <p className="text-base md:text-lg font-body text-slate-500 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="grid sm:grid-cols-3 gap-0 sm:gap-6">
            {[
              ...
              <div key={i} className="flex flex-col items-center text-center">
                ...
                {/* Role */}
                <div className="text-base font-sans font-bold text-boon-charcoal mb-0.5">
                  {stage.role}
                </div>

                {/* Year */}
                <div className="text-sm font-body text-slate-400 mb-3">
                  {stage.year}
                </div>
                ...
                <div className="flex items-center gap-1.5 mt-2">
                  <X className="w-4 h-4 text-boon-coral flex-shrink-0" />
                  <span className="text-sm font-body text-slate-400 italic">{stage.pain}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="rounded-2xl border border-boon-blue/15 bg-boon-blue/[0.03] p-8 md:p-12">
        <div className="mb-8 text-center">
          ...
          <p className="text-base md:text-lg font-body text-boon-charcoal max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="relative">
            ...
            {[
              ...
              <div key={i} className="flex flex-col items-center text-center">
                ...
                <div className="px-3 py-1.5 rounded mb-2" style={{ backgroundColor: `${stage.color}15` }}>
                  <div className="text-sm font-body font-bold" style={{ color: stage.color }}>
                    Boon {stage.product}
                  </div>
                </div>

                {/* Context note */}
                <div className="text-sm font-body text-slate-500 italic px-2">
                  {stage.context}
                </div>
              </div>
            ))}
          ...
          <div className="mt-4 mx-auto rounded-lg bg-emerald-50 border border-emerald-200/50 px-4 py-2.5 text-center" style={{ width: 'calc(100% - 2rem)' }}>
            <span className="text-sm font-body font-bold text-emerald-600 tracking-wide">
              Boon TOGETHER
            </span>
            <span className="text-sm font-body text-emerald-600/70 ml-2">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-x-8 gap-y-3 pt-6">
            {[
              ...
              <div key={i} className="flex items-center gap-2">
                ...
                <span className="text-base font-body font-medium text-boon-charcoal">{benefit}</span>
              </div>
            ))}
          </div>
        </div>
