  ...
  return (
    <section className="pt-40 pb-32 px-6 md:px-12 lg:px-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-[1.3fr_0.7fr] gap-24 items-center relative z-10">
        <div>
          <h1 className="reveal stagger-1 font-architectural text-7xl md:text-[115px] text-boon-charcoal mb-12">
            The leadership development system you won&apos;t <span className="font-serif italic text-boon-blue">outgrow</span>.
          </h1>

          <p className="reveal stagger-2 text-xl md:text-2xl text-gray-500 font-body font-semibold leading-relaxed max-w-2xl mb-16">
          ...
          <div className="reveal stagger-3 flex flex-col sm:flex-row gap-6">
            <Link
              href="/solutions"
              className="bg-boon-blue text-white px-12 py-6 rounded-2xl font-sans font-bold text-xl hover:bg-boon-deep-blue transition-all shadow-2xl shadow-boon-blue/20 active:scale-95 text-center"
            >
              See how it works
            </Link>
            <Link
              href="/solutions"
              className="border border-gray-200 text-boon-charcoal px-12 py-6 rounded-2xl font-sans font-bold text-xl hover:bg-boon-off-white transition-all active:scale-95 text-center"
            >
              How It Works
            </Link>
          </div>
