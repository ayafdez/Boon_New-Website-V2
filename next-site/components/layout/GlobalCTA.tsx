  ...
  return (
    <section className="py-20 md:py-40 px-6 md:px-12 lg:px-24 bg-boon-navy text-white text-center relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <Link
          href="/demo"
          className="inline-block bg-boon-coral text-white px-8 py-4 md:px-12 md:py-6 rounded-[15px] font-sans font-bold text-lg md:text-lg hover:scale-105 transition-all shadow-2xl shadow-boon-coral/30"
        >
