  ...
  return (
    <section className="py-16 md:py-32 px-6 md:px-12 lg:px-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Section header — matches homepage section style */}
        ...
        {/* Tab content */}
        <div
          className="grid lg:grid-cols-[1fr_1.1fr] gap-12 lg:gap-20 items-center"
          style={{
            opacity: visible ? 1 : 0,
        ...
        >
          ...
          <div className="flex flex-col justify-center">
            <p className="label-text text-[10px] text-boon-blue mb-4">{content.label}</p>
          ...
          {/* Right — image */}
          <div className="relative rounded-[20px] overflow-hidden shadow-2xl aspect-[4/3] bg-gray-50">
