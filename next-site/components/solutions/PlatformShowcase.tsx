  ...
  return (
    <section className="py-16 md:py-32 px-6 md:px-12 lg:px-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Tabs + content — wrapped together in max-w-5xl matching homepage structure */}
        <div className="w-full max-w-5xl mx-auto">
          ...
          >
            {/* Left — copy */}
            <div>
              <span className={`label-text text-[10px] self-start px-3 py-1 rounded-full mb-6 inline-block ${content.badgeColor}`}>
                {content.badge}
              </span>
